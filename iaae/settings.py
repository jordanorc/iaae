# Django settings for iaae project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'nlp.db'), # Or path to database file if using sqlite3.
...
SECRET_KEY = 'su75(ean7@tocs9v%qdu+yny+(2czn&amp;w-lfr+x2pynwn-wyqx1'
...
ROOT_URLCONF = 'iaae.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'iaae.wsgi.application'
